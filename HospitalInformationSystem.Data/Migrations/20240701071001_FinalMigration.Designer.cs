...
namespace HospitalInformationSystem.Data.Migrations
{
    ...
    [Migration("20240701071001_FinalMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HospitalInformationSystem.Models.Models.Actions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NurseNatinalId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HospitalInformationSystem.Models.Models.Medication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HospitalInformationSystem.Models.Models.PatientRoom", b =>
                {
                    ...
                    b.Property<string>("NormalRoomType")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HospitalInformationSystem.Models.Models.Transfer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("FromDoctorName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ToDoctorName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HospitalInformationSystem.Models.Models.Employee", b =>
                {
                    b.HasOne("HospitalInformationSystem.Models.Models.Department", "DepartmentS")
                        .WithMany("Employees")
                        .HasForeignKey("DepartmentId");
